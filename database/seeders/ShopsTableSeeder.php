...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'pic_path' => 'https://advance-pic-backet.s3.ap-northeast-1.amazonaws.com/sushi.jpeg',
        ];
        ...
        $param = [
            ...
            'pic_path' => 'https://advance-pic-backet.s3.ap-northeast-1.amazonaws.com/yakiniku.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 40,
            ...
            'pic_path' => 'https://advance-pic-backet.s3.ap-northeast-1.amazonaws.com/izakaya.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 13,
            ...
            'pic_path' => 'https://advance-pic-backet.s3.ap-northeast-1.amazonaws.com/italian.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 40,
            ...
            'pic_path' => 'https://advance-pic-backet.s3.ap-northeast-1.amazonaws.com/ramen.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 13,
